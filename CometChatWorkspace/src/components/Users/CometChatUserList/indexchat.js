...
class CometChatUserList extends React.PureComponent {
  ...
  listHeaderComponent = () => {
    return (
      <View style={[styles1.contactHeaderStyle]}>
        {/* <Text style={style.contactHeaderTitleStyle}></Text> */}
...
{/* {where=="chat"?  */}
<View style={{paddingTop:55,flexDirection:"row",backgroundColor:"#558B2F"}}>
            <TouchableOpacity style={[styles1.closeIcon,{}]} onPress={this.goBack}>            
              ...
              <Text style={{fontSize:22,fontWeight:"bold",color:"white"}}>Mesajı İlet</Text></View>
              </View>
            </TouchableOpacity>
         </View>
        {/* //  :null} */}
        ...
        <TouchableWithoutFeedback
          ...
          <KeyboardAvoidingView
            ...
            style={[style.contactWrapperStyle,{flexDirection:"row",justifyContent:"center"}]}>
...
//     // console.log('0909',userids,where,username);
//     this.checkRestrictions();
//     try {
//       if (Object.prototype.hasOwnProperty.call(this.props, 'friendsOnly')) {
//         this.friendsOnly = this.props.friendsOnly;
...
//       <CometChatContextProvider ref={(el) => (this.contextProviderRef = el)}>
//          {/* {1- GERİ GİT} */}
//          {where=="chat"? <View style={{paddingTop:55,flexDirection:"row"}}>
//             <TouchableOpacity style={[styles1.closeIcon,{}]} onPress={this.goBack}>
//              <View style={{flexDirection:"row"}}>
//                <View style={[styles1.closeIcon1]}>
//                <Image
...
//               </View>
//               <View style={{paddingLeft:22,justifyContent:"center"}}>
//               <Text style={{fontSize:22,fontWeight:"bold",color:constants.primarycolor}}>Mesajı İlet</Text></View>
//               </View>
//             </TouchableOpacity>
//          </View>
//          :null}
...
//             {where=="chat"?this.listHeaderComponent():null}
//             <FlatList
//               data={userListWithHeaders}
//               renderItem={this.renderUserView}
//               contentContainerStyle={{ flexGrow: 1 }}
